try:
        ...
        def send(no):
                ...
                #return True
        no=int(input("\033[0m[\033[0m\033[1;32m+\033[0m] \033[1;77mMasukan Nomor Target: \033[0m"))
        jlm=int(input("\033[0m[\033[0m\033[1;35m?\033[0m] \033[1;77mJumlah: \033[0m"))
        print
        if jlm > 50:
                print
...
except KeyboardInterrupt: exit("\033[0m[\033[1;31m Exit \033[0m] \033[1;77mKunci tidak sesuai")
except Exception as F: print("\033[0m[\033[0m\033[1;31m!\033[0m] \033[1;77mTerganggu: \033[0m%s"%(F))
